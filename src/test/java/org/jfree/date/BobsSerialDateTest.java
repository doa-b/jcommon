...
//        assertEquals("zaterdag", Day.parse(Day.SATURDAY.toString()));
    ...
    public void testMonthCodeToString() throws Exception {
        assertEquals("januari", monthCodeToString(JANUARY));
        assertEquals("februari", monthCodeToString(FEBRUARY));
        assertEquals("maart", monthCodeToString(MARCH));
        assertEquals("april", monthCodeToString(APRIL));
        assertEquals("mei", monthCodeToString(MAY));
        assertEquals("juni", monthCodeToString(JUNE));
        assertEquals("juli", monthCodeToString(JULY));
        assertEquals("augustus", monthCodeToString(AUGUST));
        assertEquals("september", monthCodeToString(SEPTEMBER));
        assertEquals("oktober", monthCodeToString(OCTOBER));
        ...
        assertEquals("mrt.", monthCodeToString(MARCH, true));
        assertEquals("apr.", monthCodeToString(APRIL, true));
        assertEquals("mei", monthCodeToString(MAY, true));
        ...
        assertEquals("okt.", monthCodeToString(OCTOBER, true));
